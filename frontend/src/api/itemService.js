...
var getItems = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, apiClient.get("/items/")];
            case 1:
                response = _a.sent();
...
var postItems = function (itemData) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, apiClient.post("/items/", itemData)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, response.data];
        }
